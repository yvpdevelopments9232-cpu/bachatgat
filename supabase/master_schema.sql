...
-- ==============================================================================
-- 42. COMPATIBILITY VIEW: BACHAT_GROUPS
-- ==============================================================================
CREATE OR REPLACE VIEW public.bachat_groups AS SELECT * FROM public.groups;

-- ==============================================================================
-- 43. RPC FUNCTIONS FOR APPLICATION
-- ==============================================================================

-- A. Forgot Password Check User Exists
...
GRANT EXECUTE ON FUNCTION public.get_auth_group_id() TO anon, authenticated, service_role;

-- C. Live Dashboard Metrics
CREATE OR REPLACE FUNCTION public.get_dashboard_metrics(p_group_id UUID)
RETURNS JSON AS $$
DECLARE
...
GRANT EXECUTE ON FUNCTION public.get_dashboard_metrics(UUID) TO anon, authenticated, service_role;

-- ==============================================================================
-- 44. GRANT FULL PERMISSIONS TO APPLICATION ROLES (anon & authenticated)
-- ==============================================================================
...
-- ==============================================================================
-- 45. PERMISSIVE ROW LEVEL SECURITY (RLS) POLICIES FOR FLUTTER CLIENT
-- ==============================================================================
DO $$ 
DECLARE 
    r RECORD;
