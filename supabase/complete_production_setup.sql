-- ==============================================================================
-- PROJECT: Sakhi Bachat Gat Management Application (सखी महिला बचत गट व्यवस्थापन ॲप)
-- COMPLETE ALL-IN-ONE PRODUCTION SUPABASE SQL SETUP
-- ==============================================================================
-- INCLUDES:
--  1. Clean 38 Tables Schema with Multi-Tenant group_id Foreign Keys
--  2. Zero-Bucket Base64 Storage Columns (TEXT type)
--  3. Schema Permissions for Flutter App (anon & authenticated roles)
--  4. Multi-Tenant Row Level Security (RLS) Policies
--  5. Dynamic Dashboard Metrics RPC Function (get_dashboard_metrics)
--  6. Seed Data for Bachat Gat A (Sangola) and Bachat Gat B (Pandharpur)
-- ==============================================================================

-- Optional: If you want a fresh reset, uncomment the following 2 lines:
